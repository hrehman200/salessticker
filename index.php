                ...
                <form method="post" action="./print.php">
                    ...
                    <fieldset class="fieldset-border">
                        ...
                        <div class="form-group row washer_dryer_set washer">
                            ...
                            <div class="col-sm-9">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="washer[]" id="stacked" value="Stacked" <?= in_array('Stacked', $_POST['washer']) ? 'checked' : '' ?>>
                                    <label class="form-check-label" for="stacked">
                                        Stacked
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="washer[]" id="steam" value="Steam" <?= in_array('Steam', $_POST['washer']) ? 'checked' : '' ?>>
                        ...
                        <div class="form-group row refrigerator">
                            ...
                            <div class="col-sm-9">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="color" id="color1" value="Stainless Steel" <?= $_POST['color'] == 'Stainless Steel' ? 'checked' : '' ?>>
                                    <label class="form-check-label" for="color1">
                                        Stainless Steel
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="color" id="color2" value="White" <?= $_POST['color'] == 'White' ? 'checked' : '' ?>>
                                    <label class="form-check-label" for="color2">
                                        White
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="color" id="color3" value="Black" <?= $_POST['color'] == 'Black' ? 'checked' : '' ?>>
                                    <label class="form-check-label" for="color3">
                                        Black
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="color" id="color4" value="Black Stainless Steel" <?= $_POST['color'] == 'Black Stainless Steel' ? 'checked' : '' ?>>
                                    <label class="form-check-label" for="color4">
                                        Black Stainless Steel
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="color" id="color5" value="Slate" <?= $_POST['color'] == 'Slate' ? 'checked' : '' ?>>
                        ...
                        <div class="form-group row stove">
                            <label for="product" class="col-sm-3 col-form-label">Range</label>
                            <div class="col-sm-9">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="stove" id="stove1" value="Gas" <?= $_POST['stove'] == 'Gas' ? 'checked' : '' ?>>
                                    <label class="form-check-label" for="stove1">
                                        Gas
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="stove" id="stove2" value="Electric" <?= $_POST['stove'] == 'Electric' ? 'checked' : '' ?>>
                                    <label class="form-check-label" for="stove2">
                                        Electric
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="stove" id="stove3" value="Dual Fuel" <?= $_POST['stove'] == 'Dual Fuel' ? 'checked' : '' ?>>
                        ...
                        <div class="form-group row washing_machine">
                            ...
                            <div class="col-sm-9">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="washingMachine" id="washingMachine" value="Steam" <?= $_POST['washingMachine'] == 'Steam' ? 'checked' : '' ?>>
                        ...
                        <div class="form-group row microwave">
                            ...
                            <div class="col-sm-9">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="microwave" id="microwave1" value="Over the Range" <?= $_POST['microwave'] == 'Over the Range' ? 'checked' : '' ?>>
                                    <label class="form-check-label" for="microwave1">
                                        Over the Range
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="microwave" id="microwave2" value="Counter Top" <?= $_POST['microwave'] == 'Counter Top' ? 'checked' : '' ?>>
                        ...
                        <div class="form-group row freezer">
                            ...
                            <div class="col-sm-9">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="freezer" id="freezer1" value="Upright" <?= $_POST['freezer'] == 'Upright' ? 'checked' : '' ?>>
                                    <label class="form-check-label" for="freezer1">
                                        Upright
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="freezer" id="freezer2" value="Chest" <?= $_POST['freezer'] == 'Chest' ? 'checked' : '' ?>>
                        ...
                        <div class="form-group row cooktop">
                            ...
                            <div class="col-sm-9">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="cooktop" id="cooktop1" value="Gas" <?= $_POST['cooktop'] == 'Gas' ? 'checked' : '' ?>>
                                    <label class="form-check-label" for="cooktop1">
                                        Gas
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="cooktop" id="cooktop2" value="Electric" <?= $_POST['cooktop'] == 'Electric' ? 'checked' : '' ?>>
                        ...
                        <div class="form-group row wall_oven">
                            ...
                            <div class="col-sm-9">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="wall_oven" id="wall_oven1" value="Gas" <?= $_POST['wall_oven'] == 'Gas' ? 'checked' : '' ?>>
                                    <label class="form-check-label" for="wall_oven1">
                                        Gas
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="wall_oven" id="wall_oven2" value="Electric" <?= $_POST['wall_oven'] == 'Electric' ? 'checked' : '' ?>>
                    ...
                    <fieldset class="fieldset-border">
                        ...
                        <div class="form-group row washer_dryer_set dryer">
                            ...
                            <div class="col-sm-9">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="dryer" id="electric1" value="Electric" <?= $_POST['dryer'] == 'Electric' ? 'checked' : '' ?>>
                                    <label class="form-check-label" for="electric1">
                                        Electric
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="dryer" id="gas1" value="Gas" <?= $_POST['dryer'] == 'Gas' ? 'checked' : '' ?>>
